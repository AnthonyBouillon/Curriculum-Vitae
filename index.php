        ...
        <nav>
            <div class="nav-wrapper">
                ...
                <ul class="right hide-on-med-and-down bold">
                    ...
                    <li><a href="Compétence-Formation-Experience#bloc1">Compétences</a></li>
                    <li><a href="Compétence-Formation-Experience#bloc2">Formations</a></li>
                    <li><a href="Compétence-Formation-Experience#bloc3">Expériences</a></li>
...
<div class="container-fluid">
    <h2 class="center-align">Bievenue sur mon CV numérique</h2>
    <p>Explication de mes motivations</p>
</div>
